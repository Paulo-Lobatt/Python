"""
nota: quando eu preciso mexer na ponta direita de algum dado, é correto eu usar Listas
mas se eu precisar mexer na ponta esquerda, nesse caso eu preciso importar o deque(em casos de volume de dados grandes)
...
fila_correta.append(3)  # Adiciona no final igual lista
fila_correta.append(4)  # Adiciona no final igual lista
fila_correta.append(5)  # Adiciona no final igual lista
